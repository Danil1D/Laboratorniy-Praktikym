...
from table_22 import opentabble_1
...
btn5.place(x = 15, y = 140, width = 180, height = 30)

btn5 = Button(root)
btn5.configure(bg = 'gray', fg = 'white', text = 'Cтворити текстовий файл', command = openTable_2)
btn5.place(x = 15, y = 170, width = 180, height = 30)
